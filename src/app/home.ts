...
import { ButtonOptions, ButtonParameters, ThreeInteractive, UIButton, UITextButton, TextButtonParameters } from 'three-fluix'
...
export class HomeScene extends Scene {
  ...
  constructor(
    ...
    const svgbutton = new UISVGButton(svgparams, app.interactive, app.uioptions)
    this.add(svgbutton)
...
class UISVGButton extends UIButton {
  constructor(parameters: SVGButtonParameters, interactive: ThreeInteractive, options: ButtonOptions) {
